...
class OrderService {
    ...
    getOrderRequestBody(order) {
        ...
        if (!order.restaurantAddress &&
            ...
            throw new Error("Either of restaurantAddress or pickup latitude/longitude is invalid");
        if (!order.customerAddress &&
            (!order.deliveryLatitude || !order.deliveryLongitude))
            throw new Error("Either of customerAddress or delivery latitude/longitude is invalid");
